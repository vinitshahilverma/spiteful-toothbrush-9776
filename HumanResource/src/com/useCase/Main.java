...
//		ChangeEmpEmail.changeEmail();
		...
		case 1 : String str = AdminLogin.admin();
			     ...
			     while(true) {
			         ...
			         int choice2 = sc.nextInt();
			          ...
			          case 2: ViewFullDetailsOfEmployee.viewFullList();
			        	     break;
			        	     
			          case 3: AddingDepartment.addDepartment();
			        	     break;
			        	     
			          case 4: AddEmployee.addEmployee();
			        	     break;
			        	     
			          case 5: updateEmpDept.updateDept();
			        	     break;
			        	     
			          case 6: ViewLeaveList.viewList();
			        	     break;
			        	     
			          case 7: ActionOnLeave.actionLeave();
			        	     break;
		...
		case 2 : String str1 = EmployeeLogin.employee();
		        ...
		        while(true) {
			         ...
			         int choice3 = sc.nextInt();
			          ...
			          case 1 :EmployeeDetails.employeeDetails();
			        	     break;
			          
			          case 2 :ChangeEmpPassword.changePassword();
			        	     break;
			        	     
			          case 3 :ChangeEmpName.changeName();
			        	     break;
			        	     
			          case 4 :ChangeEmpEmail.changeEmail();
			        	     break;
			        	     
			          case 5 :ApplyLeave.applyLeave();
			        	     break;
			        	     
			          case 6 :ViewPersonalLeave.leave();
			        	     break;
